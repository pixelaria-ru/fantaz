    ...
    <div class="table__body">
      ...
      <div class="table__row product-row">
        <div class="table__cell table__cell--row">
          <a href="<?=$arItem['DETAIL_PAGE_URL']?>" class="product-row__img"><img src="<?=$arItem['PREVIEW_PICTURE']['SRC']?>" alt="" class="img img--responsive"></a>
        ...
        <div class="table__cell table__cell--clear">
          <span 
            ...
            data-event="jqm" 
            data-name="callprice"
            data-title="на <?=$arItem['PROPERTIES']['MODEL']['VALUE']?>"
...
<div class="table__result">
  <div class="pull--left">По заданным параметрам <b><?=getNumEnding($counter,$endings_find)?> <span><?=$counter?></span> <?=getNumEnding($counter,$endings_des)?></b></div>
  <div class="pull--right"><span id="to-filter" class="link link--orange">Изменить условия отбора</span></div>
</div>
</div>
</section>
<? } ?>