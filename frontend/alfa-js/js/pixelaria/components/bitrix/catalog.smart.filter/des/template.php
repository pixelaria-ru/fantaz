...
$res = CIBlockElement::GetList(
  array('PROPERTY_M_POWER_RESERVE_KVA' => 'DESC'), //arOrder
  array('IBLOCK_ID' => '3'), //arFilter
  array('PROPERTY_M_POWER_RESERVE_KVA'), //arGroupBy
  false
);

while ($el = $res->Fetch()) {
  $tmp[] = $el['PROPERTY_M_POWER_RESERVE_KVA_VALUE'];
}
$max = $tmp[0];


$pixelaria = array();
$pixelaria['section'] = $arResult['SECTION']['ID'];
$pixelaria['start'] = 5;
$pixelaria['end'] = 3500;

$pixelaria['power_1'] = 'Основная';
$pixelaria['power_2'] = 'Резервная';

$pixelaria['code'] = 'M_POWER_MAIN_KVT';
$pixelaria['data_type'] = 'MAIN';
        ...
        <form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
          <div class="filter__row">
            <div class="filter-inline">
              ...
              <span class="filter-inline__link" data-type="MAIN">Основная</span>
              <span class="filter-inline__link" data-type="RESERVE">Резервная</span>
            </div>
            <div class="filter-inline">
                ...
                switch ($arItem["DISPLAY_TYPE"])
                {
                  ...
                  case "B"://NUMBERS_WITH_SLIDER
                    if (isset($arItem["VALUES"]["MAX"]["HTML_VALUE"]) && isset($arItem["VALUES"]["MIN"]["HTML_VALUE"])) {
                      ...
                      if (strpos($arItem['CODE'],"RESERVE"))
                        $pixelaria['data_type'] = "RESERVE";
                      else
                        $pixelaria['data_type'] = "MAIN";
