<?if(!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED!==true)die();
  ...
  foreach ($arResult['PROPERTIES'] as $property) {
    ...
    $hint=CIBlockProperty::GetByID($property["ID"], $property["IBLOCK_ID"])->GetNext()["HINT"]?:'';
    $hints[$property['CODE']] = $hint;
  }
  //M_ENGINE_MF
        ...
        <div class="product-page__info">
          ...
          <div class="product__clear">
            ...
            <div class="checkbox checkbox--small product__checkbox">
              <input <?if($_SESSION['CATALOG_COMPARE_LIST'][3]['ITEMS'][$arResult['ID']]){?> checked="checked"<?}?>  id="compare_<?=$arResult['ID']?>" name="product" type="checkbox"  class="checkbox__input">
            ...
            <div class="product-params">
              <div class="product__param product-param product-param--flash-orange">
                <div class="product-param__title">
                  Электрическая мощность <span>(?)</span>:
                  <div class="product-param__help"><div class="help__inner">
                    <?=htmlspecialchars_decode($hints['M_POWER_ELECTRIC_KVT'])?>
                  </div></div>
                </div>
                <div class="product-param__value"><?=$properties['M_POWER_ELECTRIC_KVT']?> кВт / <?=$properties['M_POWER_ELECTRIC_KVA']?> кВА</div>
              </div>
              <div class="product__param product-param product-param--engine">
                <div class="product-param__title">
                  Двигатель <span>(?)</span>:
                  <div class="product-param__help"><div class="help__inner">
                    <?=htmlspecialchars_decode($hints['M_ENGINE_MF'])?>
                  </div></div>
                </div>
              ...
              <div class="product__param product-param product-param--electro">
                <div class="product-param__title">
                  ...
                  <div class="product-param__help"><div class="help__inner">
                    <?=htmlspecialchars_decode($hints['VOLTAGE'])?>
                  </div></div>
                </div>
              ...
              <div class="product__param product-param product-param--flash-white">
                <div class="product-param__title">
                  Тепловая мощность <span>(?)</span>:
                  <div class="product-param__help"><div class="help__inner">
                    <?=htmlspecialchars_decode($hints['M_POWER_THERMAL_KVT'])?>
                  </div></div>
                </div>
                <div class="product-param__value"><?=$properties['M_POWER_THERMAL_KVT']?> кВт / <?=$properties['M_POWER_THERMAL_KVA']?> кВА</div>
              </div>
              <div class="product__param product-param product-param--battery">
                <div class="product-param__title">
                  Генератор <span>(?)</span>:
                  <div class="product-param__help"><div class="help__inner">
                    <?=htmlspecialchars_decode($hints['M_GENERATOR'])?>
                  </div></div>
                </div>
          ...
          <div class="product__types product-types">
            <div class="product-types__title">
              ...
              <div class="product-types__icon">
                <span>?</span>
                <div class="product-param__help"><div class="help__inner">
                  <?=htmlspecialchars_decode($hints['M_PRODUCT_TYPE'])?>
                </div></div>
              </div>
            </div>
        ...
        <div class="tabs__body" data-name="tab-3">
          ...
          <ul class="list list--flash">
            <?foreach ($properties['OPTIONS'] as $option) {?>
              <li class="list__item" style="width: 49%; vertical-align:top; display: inline-block; line-height: 1.5"><?=$option?>
            <?}?>
          </ul>
        </div>
        <?}?>
          ...
          <div class="related__item">
            ...
            <div class="related__desc">
              ...
              <ul class="list related__params">
                <li class="list__item related__param"><span>Электрическая мощность:</span> <?=$arProps['M_POWER_MAIN_KVT']['VALUE']?> кВт / <?=$arProps['M_POWER_MAIN_KVA']['VALUE']?> кВа</li>
