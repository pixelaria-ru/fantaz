...
<section class="section section--page">
  <div class="container">
    ...
    ?>
    <div class="page row">
      <div class="page__info col-md-8 col-lg-7">
        <h1 class="page__title"><?=$arSection['UF_SECTION_NAME']?></h1>
        <?
        foreach ($arSection['UF_PREVIEW'] as $preview) {?>
            <p class="page__subtitle"><?=htmlspecialchars($preview)?></p>
        <?}?>
        <a class="btn btn--orange">Получить консультацию</a>
      </div>
      <?if ($arSection["UF_PROJECTS"]) {?>
        <div class="page__project col-md-4 col-lg-5">
          <div class="projects">
            <div class="projects__item project project--single">
              <div class="project__image">
                <img src="<?=SITE_TEMPLATE_PATH?>/img/project.png" alt="" class="img img--responsive">
              </div>
              <div class="project__desc">
                <div class="project__customer"><span>Заказчик: </span> Ростурбинстрой</div>
                <div class="project__icon"><img src="<?=SITE_TEMPLATE_PATH?>/img/project-icon.png" alt="" class="img img--responsive"></div>
